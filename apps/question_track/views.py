...
# from apps.question_track.forms import *
...
#         else:
#             return render(request,'question_track/testjump.html')
#
...
#             }
#             print(forms.errors)
#             return render(request,'question_track/testjump.html',context=context)
#
#
# class Register(View):
#     def get(self,request):
