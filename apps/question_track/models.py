...
#     )
#
#     creator = models.ForeignKey('account.User',on_delete=models.CASCADE,related_name='creator_User')
#     createdate = models.DateTimeField(null=False,auto_now=True,db_index=True)
#     principal = models.ForeignKey('account.User',on_delete=models.CASCADE,related_name='principal_User')
...
#         permissions=(
#             ('view_applynew','can view applynew')
#         )
